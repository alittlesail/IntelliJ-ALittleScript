...
public class ALittleParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // assert LPAREN (valueStat (COMMA valueStat)*)? RPAREN SEMI
  ...
  private static boolean assertExpr_2_0_1(PsiBuilder b, int l) {
    ...
    while (true) {
      ...
      if (!assertExpr_2_0_1_0(b, l + 1)) break;
  ...
  // COMMA valueStat
  private static boolean assertExpr_2_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "assertExpr_2_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // bind LPAREN (valueStat bindStatValueStatPair*)? RPAREN
  ...
  // (valueStat bindStatValueStatPair*)?
  ...
  /* ********************************************************** */
  // COMMA valueStat
  static boolean bindStatValueStatPair(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bindStatValueStatPair")) return false;
  ...
  /* ********************************************************** */
  // accessModifier? coModifier? fun methodNameDec templateDec? methodParamDec methodReturnDec? methodBodyDec
  public static boolean classMethodDec(PsiBuilder b, int l) {
    ...
    p = r; // pin = 3
    r = r && report_error_(b, methodNameDec(b, l + 1));
    r = p && report_error_(b, classMethodDec_4(b, l + 1)) && r;
    r = p && report_error_(b, methodParamDec(b, l + 1)) && r;
    r = p && report_error_(b, classMethodDec_6(b, l + 1)) && r;
    r = p && methodBodyDec(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // templateDec?
  private static boolean classMethodDec_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "classMethodDec_4")) return false;
    templateDec(b, l + 1);
    return true;
  }

  // methodReturnDec?
  private static boolean classMethodDec_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "classMethodDec_6")) return false;
  ...
  /* ********************************************************** */
  // accessModifier? coModifier? static methodNameDec templateDec? methodParamDec methodReturnDec? methodBodyDec
  public static boolean classStaticDec(PsiBuilder b, int l) {
    ...
    p = r; // pin = 3
    r = r && report_error_(b, methodNameDec(b, l + 1));
    r = p && report_error_(b, classStaticDec_4(b, l + 1)) && r;
    r = p && report_error_(b, methodParamDec(b, l + 1)) && r;
    r = p && report_error_(b, classStaticDec_6(b, l + 1)) && r;
    r = p && methodBodyDec(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // templateDec?
  private static boolean classStaticDec_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "classStaticDec_4")) return false;
    templateDec(b, l + 1);
    return true;
  }

  // methodReturnDec?
  private static boolean classStaticDec_6(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "classStaticDec_6")) return false;
    methodReturnDec(b, l + 1);
    return true;
  }
  ...
  public static boolean globalMethodDec(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, methodParamDec(b, l + 1)) && r;
    r = p && report_error_(b, globalMethodDec_7(b, l + 1)) && r;
    r = p && methodBodyDec(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  // methodReturnDec?
  private static boolean globalMethodDec_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "globalMethodDec_7")) return false;
    methodReturnDec(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // LBRACK (valueStat opNewListStatValueStatPair*)? RBRACK
  ...
  // (valueStat opNewListStatValueStatPair*)?
  ...
  /* ********************************************************** */
  // COMMA valueStat
  static boolean opNewListStatValueStatPair(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "opNewListStatValueStatPair")) return false;
    if (!nextTokenIs(b, COMMA)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, COMMA);
  ...
  /* ********************************************************** */
  // new (customType | genericType) LPAREN (valueStat opNewStatValueStatPair*)? RPAREN
  ...
  // (valueStat opNewStatValueStatPair*)?
  ...
  /* ********************************************************** */
  // COMMA valueStat
  static boolean opNewStatValueStatPair(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "opNewStatValueStatPair")) return false;
    if (!nextTokenIs(b, COMMA)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, COMMA);
  ...
  /* ********************************************************** */
  // LESS allType propertyValueMethodTemplatePair* GREATER
  ...
  // propertyValueMethodTemplatePair*
  private static boolean propertyValueMethodTemplate_2(PsiBuilder b, int l) {
    ...
    while (true) {
      int c = current_position_(b);
      if (!propertyValueMethodTemplatePair(b, l + 1)) break;
  ...
  /* ********************************************************** */
  // COMMA allType
  static boolean propertyValueMethodTemplatePair(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "propertyValueMethodTemplatePair")) return false;
    if (!nextTokenIs(b, COMMA)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, COMMA);
  ...
  /* ********************************************************** */
  // tcall LPAREN (valueStat tcallStatValueStatPair*)? RPAREN
  ...
  // (valueStat tcallStatValueStatPair*)?
  ...
  /* ********************************************************** */
  // COMMA valueStat
  static boolean tcallStatValueStatPair(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "tcallStatValueStatPair")) return false;
    if (!nextTokenIs(b, COMMA)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, COMMA);
  ...
  /* ********************************************************** */
  // throw LPAREN (valueStat (COMMA valueStat)*)? RPAREN SEMI
  ...
  private static boolean throwExpr_2_0_1(PsiBuilder b, int l) {
    ...
    while (true) {
      int c = current_position_(b);
      if (!throwExpr_2_0_1_0(b, l + 1)) break;
  ...
  // COMMA valueStat
  private static boolean throwExpr_2_0_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "throwExpr_2_0_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && valueStat(b, l + 1);
  ...
  /* ********************************************************** */
  // opNewStat | op3Stat | op2Stat | op4Stat | op5Stat | op6Stat | op7Stat | op8Stat | valueFactorStat | opNewListStat | bindStat | tcallStat | methodParamTailDec
