...
public interface ALittleTypes {
  ...
  IElementType ALL_TYPE_CONST = new ALittleElementType("ALL_TYPE_CONST");
  IElementType ASSERT_EXPR = new ALittleElementType("ASSERT_EXPR");
  IElementType ATTRIBUTE_MODIFIER = new ALittleElementType("ATTRIBUTE_MODIFIER");
  IElementType BIND_STAT = new ALittleElementType("BIND_STAT");
  IElementType CLASS_BODY_DEC = new ALittleElementType("CLASS_BODY_DEC");
  IElementType CLASS_CTOR_DEC = new ALittleElementType("CLASS_CTOR_DEC");
  IElementType CLASS_DEC = new ALittleElementType("CLASS_DEC");
  IElementType CLASS_ELEMENT_DEC = new ALittleElementType("CLASS_ELEMENT_DEC");
  ...
  IElementType COROUTINE_STAT = new ALittleElementType("COROUTINE_STAT");
  ...
  IElementType CUSTOM_TYPE_NAME = new ALittleElementType("CUSTOM_TYPE_NAME");
  IElementType CUSTOM_TYPE_TEMPLATE = new ALittleElementType("CUSTOM_TYPE_TEMPLATE");
  IElementType DO_WHILE_BODY = new ALittleElementType("DO_WHILE_BODY");
  IElementType DO_WHILE_CONDITION = new ALittleElementType("DO_WHILE_CONDITION");
  IElementType DO_WHILE_EXPR = new ALittleElementType("DO_WHILE_EXPR");
  IElementType ELSE_BODY = new ALittleElementType("ELSE_BODY");
  IElementType ELSE_EXPR = new ALittleElementType("ELSE_EXPR");
  IElementType ELSE_IF_BODY = new ALittleElementType("ELSE_IF_BODY");
  IElementType ELSE_IF_CONDITION = new ALittleElementType("ELSE_IF_CONDITION");
  IElementType ELSE_IF_EXPR = new ALittleElementType("ELSE_IF_EXPR");
  IElementType EMPTY_EXPR = new ALittleElementType("EMPTY_EXPR");
  IElementType ENUM_BODY_DEC = new ALittleElementType("ENUM_BODY_DEC");
  ...
  IElementType FOR_BODY = new ALittleElementType("FOR_BODY");
  IElementType FOR_CONDITION = new ALittleElementType("FOR_CONDITION");
  ...
  IElementType GENERIC_FUNCTOR_PARAM_ONE_TYPE = new ALittleElementType("GENERIC_FUNCTOR_PARAM_ONE_TYPE");
  ...
  IElementType GENERIC_FUNCTOR_RETURN_ONE_TYPE = new ALittleElementType("GENERIC_FUNCTOR_RETURN_ONE_TYPE");
  ...
  IElementType IF_BODY = new ALittleElementType("IF_BODY");
  IElementType IF_CONDITION = new ALittleElementType("IF_CONDITION");
  IElementType IF_EXPR = new ALittleElementType("IF_EXPR");
  IElementType INSTANCE_DEC = new ALittleElementType("INSTANCE_DEC");
  IElementType LANGUAGE_BODY_DEC = new ALittleElementType("LANGUAGE_BODY_DEC");
  IElementType LANGUAGE_MODIFIER = new ALittleElementType("LANGUAGE_MODIFIER");
  IElementType LANGUAGE_NAME_DEC = new ALittleElementType("LANGUAGE_NAME_DEC");
  IElementType METHOD_BODY_DEC = new ALittleElementType("METHOD_BODY_DEC");
  IElementType METHOD_GETTER_PARAM_DEC = new ALittleElementType("METHOD_GETTER_PARAM_DEC");
  ...
  IElementType METHOD_RETURN_ONE_DEC = new ALittleElementType("METHOD_RETURN_ONE_DEC");
  IElementType METHOD_RETURN_TAIL_DEC = new ALittleElementType("METHOD_RETURN_TAIL_DEC");
  IElementType METHOD_SETTER_PARAM_DEC = new ALittleElementType("METHOD_SETTER_PARAM_DEC");
  IElementType MODIFIER = new ALittleElementType("MODIFIER");
  IElementType NAMESPACE_DEC = new ALittleElementType("NAMESPACE_DEC");
  IElementType NAMESPACE_ELEMENT_DEC = new ALittleElementType("NAMESPACE_ELEMENT_DEC");
  IElementType NAMESPACE_NAME_DEC = new ALittleElementType("NAMESPACE_NAME_DEC");
  IElementType NATIVE_MODIFIER = new ALittleElementType("NATIVE_MODIFIER");
  IElementType NULLABLE_MODIFIER = new ALittleElementType("NULLABLE_MODIFIER");
  ...
  IElementType PATHS_VALUE = new ALittleElementType("PATHS_VALUE");
  ...
  IElementType PROTOCOL_MODIFIER = new ALittleElementType("PROTOCOL_MODIFIER");
  IElementType REFLECT_CUSTOM_TYPE = new ALittleElementType("REFLECT_CUSTOM_TYPE");
  IElementType REFLECT_VALUE = new ALittleElementType("REFLECT_VALUE");
  IElementType REFLECT_VALUE_STAT = new ALittleElementType("REFLECT_VALUE_STAT");
  ...
  IElementType STRUCT_BODY_DEC = new ALittleElementType("STRUCT_BODY_DEC");
  ...
  IElementType STRUCT_OPTION_DEC = new ALittleElementType("STRUCT_OPTION_DEC");
  IElementType STRUCT_OPTION_NAME_DEC = new ALittleElementType("STRUCT_OPTION_NAME_DEC");
  ...
  IElementType TEMPLATE_NAME_DEC = new ALittleElementType("TEMPLATE_NAME_DEC");
  ...
  IElementType VALUE_OP_STAT = new ALittleElementType("VALUE_OP_STAT");
  ...
  IElementType WHILE_BODY = new ALittleElementType("WHILE_BODY");
  IElementType WHILE_CONDITION = new ALittleElementType("WHILE_CONDITION");
  ...
  IElementType BLOCK_COMMENT = new ALittleTokenType("BLOCK_COMMENT");
  ...
  IElementType CO = new ALittleTokenType("co");
  ...
  IElementType HTTPDOWNLOAD = new ALittleTokenType("HttpDownload");
  IElementType HTTPUPLOAD = new ALittleTokenType("HttpUpload");
  ...
  IElementType LANGUAGE = new ALittleTokenType("Language");
  ...
  IElementType NATIVE = new ALittleTokenType("Native");
  ...
  IElementType NULLABLE = new ALittleTokenType("Nullable");
  IElementType NUMBER_CONTENT = new ALittleTokenType("NUMBER_CONTENT");
  IElementType OPTION = new ALittleTokenType("option");
  IElementType PATHS = new ALittleTokenType("paths");
  ...
  IElementType TEXT_CONTENT = new ALittleTokenType("TEXT_CONTENT");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ACCESS_MODIFIER) {
      ...
      else if (type == ALL_TYPE_CONST) {
        return new ALittleAllTypeConstImpl(node);
      }
      else if (type == ASSERT_EXPR) {
        return new ALittleAssertExprImpl(node);
      }
      else if (type == ATTRIBUTE_MODIFIER) {
        return new ALittleAttributeModifierImpl(node);
      }
      else if (type == BIND_STAT) {
        return new ALittleBindStatImpl(node);
      }
      else if (type == CLASS_BODY_DEC) {
        return new ALittleClassBodyDecImpl(node);
      }
      ...
      else if (type == CLASS_ELEMENT_DEC) {
        return new ALittleClassElementDecImpl(node);
      }
      ...
      else if (type == COMMAND_MODIFIER) {
        return new ALittleCommandModifierImpl(node);
      }
      else if (type == CONST_MODIFIER) {
        return new ALittleConstModifierImpl(node);
      }
      ...
      else if (type == COROUTINE_STAT) {
        return new ALittleCoroutineStatImpl(node);
      }
      ...
      else if (type == CUSTOM_TYPE_NAME) {
        return new ALittleCustomTypeNameImpl(node);
      }
      else if (type == CUSTOM_TYPE_TEMPLATE) {
        return new ALittleCustomTypeTemplateImpl(node);
      }
      else if (type == DO_WHILE_BODY) {
        return new ALittleDoWhileBodyImpl(node);
      }
      else if (type == DO_WHILE_CONDITION) {
        return new ALittleDoWhileConditionImpl(node);
      }
      else if (type == DO_WHILE_EXPR) {
        return new ALittleDoWhileExprImpl(node);
      }
      else if (type == ELSE_BODY) {
        return new ALittleElseBodyImpl(node);
      }
      else if (type == ELSE_EXPR) {
        return new ALittleElseExprImpl(node);
      }
      else if (type == ELSE_IF_BODY) {
        return new ALittleElseIfBodyImpl(node);
      }
      else if (type == ELSE_IF_CONDITION) {
        return new ALittleElseIfConditionImpl(node);
      }
      ...
      else if (type == ENUM_BODY_DEC) {
        return new ALittleEnumBodyDecImpl(node);
      }
        ...
        return new ALittleForBodyImpl(node);
      }
      else if (type == FOR_CONDITION) {
        return new ALittleForConditionImpl(node);
      }
      ...
      else if (type == GENERIC_FUNCTOR_PARAM_ONE_TYPE) {
        return new ALittleGenericFunctorParamOneTypeImpl(node);
      }
      ...
      else if (type == GENERIC_FUNCTOR_RETURN_ONE_TYPE) {
        return new ALittleGenericFunctorReturnOneTypeImpl(node);
      }
        ...
        return new ALittleIfBodyImpl(node);
      }
      else if (type == IF_CONDITION) {
        return new ALittleIfConditionImpl(node);
      }
      ...
      else if (type == LANGUAGE_BODY_DEC) {
        return new ALittleLanguageBodyDecImpl(node);
      }
      else if (type == LANGUAGE_MODIFIER) {
        return new ALittleLanguageModifierImpl(node);
      }
      else if (type == LANGUAGE_NAME_DEC) {
        return new ALittleLanguageNameDecImpl(node);
      }
      else if (type == METHOD_BODY_DEC) {
        return new ALittleMethodBodyDecImpl(node);
      }
      else if (type == METHOD_GETTER_PARAM_DEC) {
        return new ALittleMethodGetterParamDecImpl(node);
      }
      ...
      else if (type == METHOD_RETURN_ONE_DEC) {
        return new ALittleMethodReturnOneDecImpl(node);
      }
      else if (type == METHOD_RETURN_TAIL_DEC) {
        return new ALittleMethodReturnTailDecImpl(node);
      }
      else if (type == METHOD_SETTER_PARAM_DEC) {
        return new ALittleMethodSetterParamDecImpl(node);
      }
      else if (type == MODIFIER) {
        return new ALittleModifierImpl(node);
      }
      else if (type == NAMESPACE_DEC) {
        return new ALittleNamespaceDecImpl(node);
      }
      else if (type == NAMESPACE_ELEMENT_DEC) {
        return new ALittleNamespaceElementDecImpl(node);
      }
      else if (type == NAMESPACE_NAME_DEC) {
        return new ALittleNamespaceNameDecImpl(node);
      }
      else if (type == NATIVE_MODIFIER) {
        return new ALittleNativeModifierImpl(node);
      }
      else if (type == NULLABLE_MODIFIER) {
        return new ALittleNullableModifierImpl(node);
      }
      else if (type == OP_1) {
      ...
      else if (type == PATHS_VALUE) {
        return new ALittlePathsValueImpl(node);
      }
      ...
      else if (type == PROTOCOL_MODIFIER) {
        return new ALittleProtocolModifierImpl(node);
      }
      else if (type == REFLECT_CUSTOM_TYPE) {
        return new ALittleReflectCustomTypeImpl(node);
      }
      else if (type == REFLECT_VALUE) {
        return new ALittleReflectValueImpl(node);
      }
      else if (type == REFLECT_VALUE_STAT) {
        return new ALittleReflectValueStatImpl(node);
      }
      ...
      else if (type == STRUCT_BODY_DEC) {
        return new ALittleStructBodyDecImpl(node);
      }
      ...
      else if (type == STRUCT_OPTION_DEC) {
        return new ALittleStructOptionDecImpl(node);
      }
      else if (type == STRUCT_OPTION_NAME_DEC) {
        return new ALittleStructOptionNameDecImpl(node);
      }
      ...
      else if (type == TEMPLATE_EXTENDS_DEC) {
        return new ALittleTemplateExtendsDecImpl(node);
      }
      else if (type == TEMPLATE_EXTENDS_STRUCT_DEC) {
        return new ALittleTemplateExtendsStructDecImpl(node);
      }
      else if (type == TEMPLATE_NAME_DEC) {
        return new ALittleTemplateNameDecImpl(node);
      }
      ...
      else if (type == VALUE_OP_STAT) {
        return new ALittleValueOpStatImpl(node);
      }
        ...
        return new ALittleWhileBodyImpl(node);
      }
      else if (type == WHILE_CONDITION) {
        return new ALittleWhileConditionImpl(node);
      }
