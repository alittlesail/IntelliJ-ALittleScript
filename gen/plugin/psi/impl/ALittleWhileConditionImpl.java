...
public class ALittleWhileConditionImpl extends ASTWrapperPsiElement implements ALittleWhileCondition {

  public ALittleWhileConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
