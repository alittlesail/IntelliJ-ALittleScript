...
public class ALittleForStepConditionImpl extends ASTWrapperPsiElement implements ALittleForStepCondition {

  public ALittleForStepConditionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ALittleVisitor visitor) {
    visitor.visitForStepCondition(this);
  }
  ...
  @Override
  @NotNull
  public ALittleForStartStat getForStartStat() {
    return findNotNullChildByClass(ALittleForStartStat.class);
  }
