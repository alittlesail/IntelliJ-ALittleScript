...
public class ALittleForExprImpl extends ASTWrapperPsiElement implements ALittleForExpr {
  ...
  @Override
  @Nullable
  public ALittleForBody getForBody() {
    return findChildByClass(ALittleForBody.class);
  }

  @Override
  @Nullable
  public ALittleForCondition getForCondition() {
    return findChildByClass(ALittleForCondition.class);
  }
