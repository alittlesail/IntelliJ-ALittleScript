...
public class ALittleVarAssignNameDecImpl extends ALittleVarAssignNameDecElementImpl implements ALittleVarAssignNameDec {

  public ALittleVarAssignNameDecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ALittleVisitor visitor) {
    visitor.visitVarAssignNameDec(this);
  }
