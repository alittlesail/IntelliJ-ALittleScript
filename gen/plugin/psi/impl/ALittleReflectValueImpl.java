...
public class ALittleReflectValueImpl extends ASTWrapperPsiElement implements ALittleReflectValue {
  ...
  @Override
  @Nullable
  public ALittleReflectCustomType getReflectCustomType() {
    return findChildByClass(ALittleReflectCustomType.class);
  }

  @Override
  @Nullable
  public ALittleReflectValueStat getReflectValueStat() {
    return findChildByClass(ALittleReflectValueStat.class);
  }
