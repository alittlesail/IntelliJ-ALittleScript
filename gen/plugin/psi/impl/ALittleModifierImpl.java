...
public class ALittleModifierImpl extends ASTWrapperPsiElement implements ALittleModifier {

  public ALittleModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ALittleAttributeModifier getAttributeModifier() {
    return findChildByClass(ALittleAttributeModifier.class);
  }
