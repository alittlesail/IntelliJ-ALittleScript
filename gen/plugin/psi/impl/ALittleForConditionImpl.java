...
public class ALittleForConditionImpl extends ASTWrapperPsiElement implements ALittleForCondition {

  public ALittleForConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ALittleForPairDec getForPairDec() {
    return findChildByClass(ALittleForPairDec.class);
  }
