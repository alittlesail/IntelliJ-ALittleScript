...
public class ALittleCustomTypeImpl extends ASTWrapperPsiElement implements ALittleCustomType {
  ...
  @Override
  @NotNull
  public ALittleCustomTypeName getCustomTypeName() {
    return findNotNullChildByClass(ALittleCustomTypeName.class);
  }

  @Override
  @Nullable
  public ALittleCustomTypeTemplate getCustomTypeTemplate() {
    return findChildByClass(ALittleCustomTypeTemplate.class);
  }
