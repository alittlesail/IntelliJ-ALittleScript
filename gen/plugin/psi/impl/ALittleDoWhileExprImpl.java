...
public class ALittleDoWhileExprImpl extends ASTWrapperPsiElement implements ALittleDoWhileExpr {
  ...
  @Override
  @Nullable
  public ALittleDoWhileBody getDoWhileBody() {
    return findChildByClass(ALittleDoWhileBody.class);
  }

  @Override
  @Nullable
  public ALittleDoWhileCondition getDoWhileCondition() {
    return findChildByClass(ALittleDoWhileCondition.class);
  }
