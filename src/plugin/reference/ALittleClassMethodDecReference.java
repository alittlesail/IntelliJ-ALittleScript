...
public class ALittleClassMethodDecReference extends ALittleReference<ALittleClassMethodDec> {
    public ALittleClassMethodDecReference(@NotNull ALittleClassMethodDec element, TextRange textRange) {
