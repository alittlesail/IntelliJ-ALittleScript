...
public class ALittleIfConditionReference extends ALittleReference<ALittleIfCondition> {
    public ALittleIfConditionReference(@NotNull ALittleIfCondition element, TextRange textRange) {
