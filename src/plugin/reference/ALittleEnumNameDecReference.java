...
public class ALittleEnumNameDecReference extends PsiReferenceBase<PsiElement> implements ALittleReference {
    ...
    public ResolveResult[] multiResolve(boolean incompleteCode) {
        ...
        final List<ALittleEnumNameDec> dec_list = ALittleTreeChangeListener.findEnumNameDecList(project, m_src_namespace, m_key);
