...
import plugin.psi.ALittleWhileCondition;

import java.util.List;

public class ALittleWhileConditionReference extends ALittleReference<ALittleWhileCondition> {
    public ALittleWhileConditionReference(@NotNull ALittleWhileCondition element, TextRange textRange) {
