...
public class ALittleCustomTypeNamespaceNameDecReference extends PsiReferenceBase<PsiElement> implements ALittleReference {
    private String m_key;

    public ALittleCustomTypeNamespaceNameDecReference(@NotNull PsiElement element, TextRange textRange) {
