...
public class ALittleDoWhileConditionReference extends ALittleReference<ALittleDoWhileCondition> {
    public ALittleDoWhileConditionReference(@NotNull ALittleDoWhileCondition element, TextRange textRange) {
