...
public class ALittleClassExtendsNamespaceNameDecReference extends PsiReferenceBase<PsiElement> implements ALittleReference {
    private String m_key;

    public ALittleClassExtendsNamespaceNameDecReference(@NotNull PsiElement element, TextRange textRange) {
