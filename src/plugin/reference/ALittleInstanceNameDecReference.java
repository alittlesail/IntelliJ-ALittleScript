...
public class ALittleInstanceNameDecReference extends PsiReferenceBase<PsiElement> implements ALittleReference {
    ...
    public ResolveResult[] multiResolve(boolean incompleteCode) {
        ...
        ALittleAllType all_type = instance_dec.getAllType();
        if (all_type != null) {
