...
public class ALittleParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORD_SET = TokenSet.create(ALittleTypes.AUTO, ALittleTypes.ANY, ALittleTypes.INT, ALittleTypes.I64, ALittleTypes.DOUBLE, ALittleTypes.STRING, ALittleTypes.BOOL,
